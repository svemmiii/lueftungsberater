...
CONF_ROOM_NOTIFY_TRIGGERS = "room_notify_triggers"
...
DEFAULT_ROOM_NOTIFY_TRIGGERS: list[str] = []
...
DATA_ROOM_HISTORY = "room_history"
...
ROOM_HISTORY_MAX_BYTES = 40 * 1024 * 1024
ROOM_HISTORY_TRIM_TARGET_BYTES = 38 * 1024 * 1024
ROOM_HISTORY_RETENTION = timedelta(days=30)
STORAGE_VERSION = 1
