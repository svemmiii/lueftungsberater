...
Ohne Fensterkontakt arbeitet der Raum rein beobachtend. Mit Fensterkontakt erkennt Lüftungsassistent automatisch, wann tatsächlich gelüftet wurde. Laufende Lüftungen und die letzte bestätigte Lüftung werden kompakt gespeichert und überstehen einen Home-Assistant-Neustart. Ein beim Start kurz `unknown`/`unavailable` gemeldeter Fensterkontakt beendet eine laufende Lüftung nicht fälschlich. Ab v0.9.0 ist diese Unsicherheit auf **2 Minuten** begrenzt: Danach wird nur der bis zuletzt sicher als offen bekannte Zeitraum gewertet, damit ein langer Sensorausfall keine Lüftungsdauer erfinden kann. Eine durch den 24-h-Fallback gestartete Routinelüftung bleibt nach dem Öffnen außerdem mindestens **fünf reale Offen-Minuten** aktiv; erst danach kann die Karte „Lüftung fertig“ melden.
